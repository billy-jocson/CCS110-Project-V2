...
<body class="bg-zinc-100">
    ...
    <!-- ═══════════════════════════════════════════════════════════
         EDIT EMPLOYEE MODAL
         Layout: left = form fields, right = profile picture
    ════════════════════════════════════════════════════════════ -->
    <div id="editModalBg"
            ...
            <form id="editForm" onsubmit="submitEdit(event)" enctype="multipart/form-data">
                ...
                <div class="flex gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center border border-zinc-200 rounded-lg px-3 py-2 gap-2 focus-within:border-sky-400">
                                    ...
                                    <input id="editFirstName" type="text"
                                        class="w-full text-sm outline-none" placeholder="Juan" required>
                                </div>
                            </div>
                            <div class="flex-1">
                                ...
                                <div class="flex items-center border border-zinc-200 rounded-lg px-3 py-2 gap-2 focus-within:border-sky-400">
                                    ...
                                    <input id="editLastName" type="text"
                                        class="w-full text-sm outline-none" placeholder="Dela Cruz" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center border border-zinc-200 rounded-lg px-3 py-2 gap-2 focus-within:border-sky-400">
                                ...
                                <input id="editContact" type="text"
                                    class="w-full text-sm outline-none" placeholder="09XXXXXXXXX" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center border border-zinc-200 rounded-lg px-3 py-2 gap-2 focus-within:border-sky-400">
                                ...
                                <input id="editUsername" type="text"
                                    class="w-full text-sm outline-none" placeholder="username123" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center border border-zinc-200 rounded-lg px-3 py-2 gap-2 focus-within:border-sky-400">
                                ...
                                <input id="editPassword" type="password"
                                    class="w-full text-sm outline-none" placeholder="Leave blank to keep current">
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col items-center gap-3 w-36">
                        ...
                        <label class="text-xs text-sky-600 cursor-pointer hover:underline">
    ...
    <!-- ═══════════════════════════════════════════════════════════
         ...
         Step 1: Department, First Name, Last Name, Contact, Position
         Step 2: Portrait Picture, Username, Password
    ════════════════════════════════════════════════════════════ -->
    <div id="addModalBg"
        class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center invisible opacity-0 transition-all duration-300">
        <div id="addModal"
            ...
            <div id="addStep2" class="hidden">
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <input id="addProfilePicture" name="profilePicture" type="file" accept="image/*"
    ...
    <div id="deleteModalBg"
        ...
        <div id="deleteModal"
            ...
            <p class="text-sm text-zinc-500 mb-6">Are you sure you want to remove <span id="deleteEmployeeName" class="font-semibold text-zinc-700"></span>? This action cannot be undone.</p>
    ...
    <script>
        ...
        // ─── Load departments into filter & add modal ───────────────────────
        ...
        function searchEmployee(input) {
            ...
            searchTimeout = setTimeout(() => {
                ...
                ).filter(emp => currentDept === '' || emp.dept_id == currentDept);
        ...
        // ─── Load positions helper ───────────────────────────────────────────
        async function loadPositions(deptId, selectId, selectedPositionId = null) {
            ...
            select.innerHTML = positions.map(p =>
                `<option value="${p.position_id}" ${selectedPositionId == p.position_id ? 'selected' : ''}>${p.position_name}</option>`
            ).join('');
        }
        ...
        async function submitAdd() {
            ...
            const pfpFile = document.getElementById('addProfilePicture').files[0];
        ...
        async function submitEdit(e) {
            ...
            const pfpFile = document.getElementById('editProfilePicture').files[0];
            if (pfpFile) formData.append('profilePicture', pfpFile);
