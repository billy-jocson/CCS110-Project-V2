...
<div class="flex flex-col h-full justify-end bg-gradient-to-b from-green-500 to-green-800 rounded-lg p-5 flex-grow-1">
    <div class="mb-3 relative isolate">
        <div class="absolute -top-30 -right-15 opacity-35 -z-10">
