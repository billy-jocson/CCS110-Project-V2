            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col lg:flex-row gap-5">
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-sm flex-1">
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr class="border-b border-zinc-50">
                                            <td class="py-2 text-zinc-600"><?php echo date('M d, Y', strtotime($row['date'])); ?></td>
                                            <td class="py-2 text-zinc-800 font-medium">₱<?php echo number_format($row['salary_amount'], 2); ?></td>
                                            <td class="py-2 text-green-600 font-medium">+₱<?php echo number_format($row['bonus'] ?? 0, 2); ?></td>
                                            <td class="py-2 text-red-500 font-medium">-₱<?php echo number_format($row['deduction'] ?? 0, 2); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                        ...
                        <?php endif; ?>
                        <a href="payrollHistory.php" class="text-xs text-sky-600 hover:underline mt-3 block">View all →</a>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-sm w-full lg:w-72">
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="flex justify-between items-center py-2 border-b border-zinc-100">
                                ...
                                <span class="text-sm font-semibold text-zinc-800">₱<?php echo number_format($sal['base_pay'] ?? 0, 2); ?></span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-zinc-100">
                                <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-semibold text-green-600">+₱<?php echo number_format($sal['bonus'] ?? 0, 2); ?></span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-zinc-100">
                                <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-semibold text-red-500">-₱<?php echo number_format($sal['deduction'] ?? 0, 2); ?></span>
                            </div>
                            <div class="flex justify-between items-center pt-2">
                                <span class="text-sm font-bold text-zinc-700">Net Salary</span>
                                <span class="text-base font-bold text-sky-600">₱<?php echo number_format($sal['net_salary'] ?? 0, 2); ?></span>
                            </div>
                        </div>
                    </div>
