...
function iconColor($page, $currentPage)
{
    return $page === $currentPage ? "text-white" : "text-zinc-600";
}

function svgStroke($page, $currentPage)
{
...
<!-- Sidebar -->
<div id="sidebar" class="flex flex-col fixed md:sticky top-0 left-0 z-50 p-7 w-80 h-screen bg-white overflow-hidden">
    <div class="w-full">
        ...
        <ul class="flex flex-col gap-2">
            ...
            <li>
                <a href="payroll.php"
                    ...
                    <i class="fa-solid fa-dollar-sign <?php echo iconColor('payroll.php', $currentPage); ?>"></i>
                    Payroll
                </a>
            </li>
            ...
            <li>
                <a href="payrollHistory.php"
                    ...
                    <i
                        class="fa-solid fa-clipboard-list <?php echo iconColor('payrollHistory.php', $currentPage); ?>"></i>
                    Payroll History
                </a>
            </li>

            <!-- Employee: Request Resignation -->
            <?php if ($isAdmin == 0): ?>
                <li>
                    <a href="requestResignation.php"
                        ...
                        <i class="fa-solid fa-pen-nib <?php echo iconColor('requestResignation.php', $currentPage); ?>"></i>
                        Request Resignation
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($isAdmin == 1): ?>
                ...
                <li>
                    <a href="employees.php"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-4 <?php echo svgStroke('employees.php', $currentPage); ?>">
                ...
                <li>
                    <a href="resignationRequests.php"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="size-4 <?php echo svgStroke('resignationRequests.php', $currentPage); ?>">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
<!-- Overlay for mobile -->
<div id="sidebarOverlay" class="fixed inset-0 bg-black/50 md:hidden z-5 transition-opacity duration-300"
