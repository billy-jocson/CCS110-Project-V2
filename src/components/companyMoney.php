...
<div class="w-56 flex flex-col justify-center bg-gradient-to-b from-green-500 to-green-800 rounded-lg p-5">
    <div class="mb-3 relative isolate">
        ...
        <h1 class="text-white font-extrabold text-2xl">₱<?php echo number_format($newValue); ?></h1>
