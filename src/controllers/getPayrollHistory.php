    ...
    if ($query->num_rows == 0) {
        ...
        while ($row = $query->fetch_assoc()) {
            ...
            echo '
                ...
                <td class="px-6 py-4 text-gray-600">₱' . number_format($row["base_pay"], 2) . '</td>
                <td class="px-6 py-4 text-green-600">₱' . number_format($row["bonus"], 2) . '</td>
                <td class="px-6 py-4 text-red-600">₱' . number_format($row["deduction"], 2) . '</td>
